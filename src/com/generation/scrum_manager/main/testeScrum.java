...
import com.generation.scrum_manager.classes.Base;
import com.generation.scrum_manager.classes.Pessoa;
import com.generation.scrum_manager.classes.Sprint;
...
public class testeScrum {
	...
	public static void main(String[] args) { 
		...
		if (op == 1) {//solicita os dados para validação
			System.out.println("Ótimo! digite a senha do responsável: ");
			senha = scan.nextInt();

			//verifica os dados e constrói a user story
		...
		// final do backlog
		// inicio da construção dos 'sprints'
		...
		else
		{
			...
			System.out.println("De acordo com a ordem prioritária, quantas funcionalidades deseja"
					+ "transferir do backlog para a sprint?");
